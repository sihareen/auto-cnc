...
Usage:
    python calibrate/04_calibrate.py              # Interactive GUI mode
    python calibrate/04_calibrate.py --verify     # Verify existing calibration
    python calibrate/04_calibrate.py --clear      # Clear and start fresh
"""
import argparse
import cv2
import json
